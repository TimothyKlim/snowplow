...
/**
  * Tests Transformer
  */
class TransformerSpec extends Specification with ValidationMatchers {
  ...
  "The 'fromClass' method" should {
    "successfully convert a tab-separated event string to JSON" in {
      ...
      ScalazJson4sUtils.extract[String](result, "collector_tstamp") must beSuccessful(
        "2013-11-26T00:02:05Z")
      ScalazJson4sUtils.extract[String](result, "geo_location") must beSuccessful(
        "37.443604,-122.4124")
