...
//
// class PostSpec extends Specification with Specs2RouteTest with AnyMatchers {
//   val testConf: Config =
...
//   val collectorService =
//     new CollectorService(collectorConfig, responseHandler, system)
...
//       CollectorPost("/com.snowplowanalytics.snowplow/tp2") ~> collectorService.routes ~> check {
//         headers shouldBe defined
//
//         val httpCookies: List[HttpCookie] = headers.collect {
//           case `Set-Cookie`(hc) => hc
//         }
//         httpCookies shouldBe defined
//
...
//         Some(HttpCookie(collectorConfig.cookieName.get, "UUID_Test"))) ~>
...
//       val storedRecordBytes = responseHandler
//         .cookie(payloadData,
//                 null,
//                 None,
//                 None,
