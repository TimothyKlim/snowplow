...
object ConversionUtils {
  ...
  val validateUuid: (String, String) => ValidatedString = (field, str) => {
    ...
    def check(s: String)(u: UUID): Boolean =
      (u != null && s.toLowerCase == u.toString)
  ...
  val validateInteger: (String, String) => ValidatedString = (field, str) => {
    try {
      ...
      case _: java.lang.NumberFormatException =>
        s"Field [$field]: [$str] is not a valid integer".failure
    }
  }
  ...
  /**
    ...
    *         a Success JInt
    */
  val stringToJInteger: (String, String) => Validation[String, JInteger] =
    (field, str) =>
  ...
  /**
    ...
    *         a Success Byte
    */
  val stringToBooleanlikeJByte: (String, String) => Validation[String, JByte] =
    (field, str) =>
      str match {
