...
case class CampaignAttributionEnrichment(
  ...
  /**
    ...
    */
  private def getFirstParameter(parameterList: List[String],
                                sourceMap: SourceMap): Option[String] =
  ...
  /**
    ...
    *         Validation
    */
  def extractMarketingFields(
      nvPairs: SourceMap): ValidationNel[String, MarketingCampaign] = {
    ...
    MarketingCampaign(medium,
                      source,
                      term,
                      content,
                      campaign,
                      clickId,
                      network).success.toValidationNel
  }
