...
object SpecHelpers {
  ...
  /**
    ...
    */
  val EnrichVersion = "kinesis-0.9.0-kt-common-0.25.0-kt"
  ...
  /**
    ...
    */
  lazy val OutputFields =
    classOf[EnrichedEvent].getDeclaredFields.map(_.getName)

  /**
    * User-friendly wrapper to instantiate
    * a BeFieldEqualTo Matcher.
    */
  def beFieldEqualTo(expected: String, withIndex: Int) =
